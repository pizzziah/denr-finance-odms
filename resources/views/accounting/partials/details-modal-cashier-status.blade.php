    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="modalContent" class="d-none">
          <div class="row g-3">
            <div class="col-md-6">
              <strong>Transaction ID:</strong> <span id="view-txn-id"></span>
            </div>
            <div class="col-md-6">
              <strong>DV No:</strong> <span id="view-dv-no"></span>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              ...
              <p id="view-particulars" class="border p-2 bg-light rounded"></p>
            </div>
            <div class="col-md-6">
              <strong>Total Debit:</strong> ₱<span id="view-debit"></span>
            </div>
            <div class="col-md-6">
          ...
          <hr>
          <h5>Credit Entries Breakdown</h5>
